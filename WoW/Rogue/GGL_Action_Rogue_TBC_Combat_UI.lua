...
local L                            = {
    ...
    EXPOSEARMORTT                  = { enUS = "Maintains 5 CP Expose Armor (skipped if a warrior keeps Sunder Armor up). Turn ON only if your raid assigned it to you — it eats your combo points",
        frFR = "Maintient Expose Armor 5 CP (ignore si un guerrier maintient Sunder). ON seulement si votre raid vous l'a assigne — ca consomme vos combo points" },
...
do
    ...
    local BUTTONS = {
        ...
        { key = "UseExposeArmor",    spell = RO.ExposeArmor,    default = false },
